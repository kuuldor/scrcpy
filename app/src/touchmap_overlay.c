...
button_value_to_label(uint8_t button) {
    switch (button) {
        ...
        case SDL_CONTROLLER_BUTTON_TOUCHPAD: return OVERLAY_LABEL_TOUCHPAD;
        default:
...
static const uint32_t overlay_glyph_data[][24] = {
    ...
    [OVERLAY_GLYPH_P] = {
        0x000000, 0x000000, 0x000000, 0x01FE00, 0x01FF00, 0x018380,
        0x0181C0, 0x0181C0, 0x0181C0, 0x018380, 0x01FF00, 0x01FE00,
        0x018000, 0x018000, 0x018000, 0x018000, 0x018000, 0x018000,
        0x018000, 0x018000, 0x018000, 0x000000, 0x000000, 0x000000,
    },
    [OVERLAY_GLYPH_Q] = {
        0x000000, 0x000000, 0x000000, 0x003E00, 0x00FF00, 0x00E380, 
        0x01C180, 0x0181C0, 0x0181C0, 0x0181C0, 0x0380C0, 0x0380C0, 
...
draw_button_label(SDL_Renderer *renderer, int center_x, int center_y,
    ...
    switch (label) {
        ...
        case OVERLAY_LABEL_TOUCHPAD: glyph = OVERLAY_GLYPH_TOUCHPAD; break;
